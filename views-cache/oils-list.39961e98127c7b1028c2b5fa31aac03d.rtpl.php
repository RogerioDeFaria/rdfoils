                        ...
                        <div class="col">
                            <div class="single-shop-product">
                                <div>    <!--class="product-upper"-->
                                    <a href="/oils/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                                        <img src="<?php echo htmlspecialchars( $value1["desphoto1"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="">
                                    </a>
                                </div>
                                <h6><a href="/oils/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["desenglishname"], ENT_COMPAT, 'UTF-8', FALSE ); ?> <em>(<?php echo htmlspecialchars( $value1["desportuguesename"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)</em></a></h6>
                            </div>                            
                        </div>                        
                        <?php } ?>
