        ...
        <form role="form" action="/admin/conditions/<?php echo htmlspecialchars( $conditions["idcondition"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="desapplications" name="desapplications" placeholder="Digite os métodos de aplicação" value="<?php echo htmlspecialchars( $conditions["desapplications"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            </div>
          </div>
          <!-- /.box-body -->
